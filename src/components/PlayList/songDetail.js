...
class SongList extends Component {
  ...
  componentDidMount() {
    ...
    ).catch(error=>{this.setState({playlist:''})})
  }).catch(error=>{this.setState({playlist:''})});
  }
                  ...
                  <div className="bk-name">
                      ...
                      <div className="bk-intr">
                        <div className="intr-art-name">
                          <img className="avatarUrl" alt="头像" src={song.avatarUrl} /><Link to={`/artists/`}>{song.nickname}</Link>
                        </div>
                      ...
                      <div className="intr-tag intr-desc">
                        <span>标签：</span>
                        <span>{song.tags.map(item => {return item+' '})}</span>
                      </div>
